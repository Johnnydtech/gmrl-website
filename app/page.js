...
export const metadata = {
  ...
  description: 'The simplest way to organize and track your workout videos. Auto-organize by workout day, tag exercises, track PRs, and find any lift instantly.',
}
        ...
        <div className="container" style={{
          ...
          <div style={{ flex: '1', minWidth: '300px', maxWidth: '500px' }}>
            ...
            <div id="download" style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
              <a href="https://apps.apple.com/app/id6757939929" className="btn btn-primary" style={{ gap: '10px' }}>
        ...
        <div className="container">
          ...
          <div style={{
            ...
            <p style={{ color: 'var(--text-tertiary)', fontSize: '14px' }}>
              © {new Date().getFullYear()} AskQuala. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
